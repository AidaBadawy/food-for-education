...
MockMainService getAndRegisterMainService() {
  _removeRegistrationIfExists<MainService>();
  final service = MockMainService();
  locator.registerSingleton<MainService>(service);
  return service;
}
